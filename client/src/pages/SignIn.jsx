...
export default function SignIn() {
  ...
  // e means event, very strange with c# events
      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mt-5'>
            Uchill ?? claro que chi XD. Para q postees tus memes de tiktok de valorant aldhair
            Ta hecho con MERN xd, inicia sesion con google 
          </p>
        </div>
